...
class LinkedList(object):
    ...
    def append(self, item):
        ...
        self.tail = new_node
        # Item was added to linked list so we add one to the size count
        self.size += 1
    ...
    def replace(self, old_item, new_item):
        ...
        # Iterate through nodes until end of list to find old_item
        while current_node is not None:
        	# 'old_item' was found so we replace it with 'new_item'
    ...
    def delete(self, item):
        ...
        if found:
            ...
            if node is self.tail:
                ...
                self.tail = previous
            # Item was deleted so decrease the size of linked list by one
            self.size -= 1
        else:
