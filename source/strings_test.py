...
class StringsTest(unittest.TestCase):
    ...
    # def disable_test_find_index_with_matching_patterns(self):
    #     # Positive test cases (examples) with matching patterns
    ...
    # def disable_test_find_index_with_non_matching_patterns(self):
    #     # Negative test cases (counterexamples) with non-matching patterns
    ...
    # def disable_test_find_index_with_complex_patterns(self):
    #     # Difficult test cases (examples) with complex patterns
    ...
    # def disable_test_find_all_indexes_with_matching_patterns(self):
    #     # Positive test cases (examples) with matching patterns
    ...
    # def disable_test_find_all_indexes_with_non_matching_patterns(self):
    #     # Negative test cases (counterexamples) with non-matching patterns
    ...
    # def disable_test_find_all_indexes_with_complex_patterns(self):
    #     # Difficult test cases (examples) with complex patterns
